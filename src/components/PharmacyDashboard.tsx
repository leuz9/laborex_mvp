...
import { CheckCircle, XCircle, Package, Phone, Calendar, Store, Bell, Map, Menu, X, ChevronDown, LogOut } from 'lucide-react';
...
export default function PharmacyDashboard({ pharmacy, requests, onConfirmAvailability, onLogout }: Props) {
